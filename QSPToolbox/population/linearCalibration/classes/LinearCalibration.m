        ...
        if istable(Obj.InputVPop.mnSDTable)
            ...
            nObservations = 2;
                ...
                iMaskSimDataRow = ...
                    ...
                    strcmp(simDataRowInfoTbl.expDataID,Obj.InputVPop.mnSDTable.expDataID{iSumStatRow});
                simVals = Obj.InputVPop.simData.Data(iMaskSimDataRow,:);
        ...
        if istable(Obj.InputVPop.corTable)
            ...
            % Loop through table rows
                ...
                jMaskSimData1Row = ...
                    ...
                    strcmp(simDataRowInfoTbl.expDataID,Obj.InputVPop.corTable.expDataID1{iSumStatRow});
                ...
                jMaskSimData2Row = ...
                    ...
                    strcmp(simDataRowInfoTbl.expDataID,Obj.InputVPop.corTable.expDataID2{iSumStatRow});
                ...
                iMaskSample1Row = (Obj.InputVPop.mnSDTable.time== Obj.InputVPop.corTable.time1(iSumStatRow)) & ...
                    ...
                    strcmp(Obj.InputVPop.mnSDTable.expDataID,Obj.InputVPop.corTable.expDataID1{iSumStatRow});
                ...
                iMaskSample2Row = (Obj.InputVPop.mnSDTable.time== Obj.InputVPop.corTable.time2(iSumStatRow)) & ...
                    ...
                    strcmp(Obj.InputVPop.mnSDTable.expDataID,Obj.InputVPop.corTable.expDataID2{iSumStatRow});
        ...
        if istable(Obj.InputVPop.distTable2D)
            ...
            % loop through table rows
                ...
                % now read the simulation data
                    ...
                    strcmp(simDataRowInfoTbl.expDataID,Obj.InputVPop.distTable2D.expDataID1{iDistTableRow});
                    simVals1 = Obj.InputVPop.simData.Data(jMaskSimData1Row,:);
                    ...
                    strcmp(simDataRowInfoTbl.expDataID,Obj.InputVPop.distTable2D.expDataID2{iDistTableRow});
                    simVals2 = Obj.InputVPop.simData.Data(jMaskSimData2Row,:);

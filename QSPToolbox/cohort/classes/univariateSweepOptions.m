classdef univariateSweepOptions
% Options object for running a univariate sweep - essentially, setting
% up and simulate a whorksheet for changing the inputs between min and
% max values one at a time.  
% Currently, we just scan the axes and run a simulation
% at the higher/lower bounds as a spot check.
%
% PROPERTIES
...
%  saveElementResultIDs:     (Optional) Just the selected simulation 
%                            outputs will be
...
%
   ...
   methods
      ...
      function obj = univariateSweepOptions() 
          obj.baseVPID = '';
          obj.varyAxisIDs={};
          obj.interventionID='';

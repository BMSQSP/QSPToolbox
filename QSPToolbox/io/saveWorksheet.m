function saveWorksheet(myWorksheet, myFileName, oldSaveFlag, myPath, myFormat)
...
if flagContinue
    ...
    if ~oldSaveFlag
        if strcmp('mat', myExtension)
            save(fullFileName, 'myWorksheet', 'myVPIDs', 'myVPCoeffs', 'pointBaseVPIndices', 'baseVPVariantSets', 'myAxisIDs','myAxisElementNames','myAxisElementTypes','myAxisBounds','myAxisScale','myResponseTypes', ['-',myFormat]);
        end
    else
        if strcmp('mat', myExtension)
